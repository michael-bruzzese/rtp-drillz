...
## 2026-02-26
- Added timer pause/resume button.
- Dark/orange visual polish and generated checkerboard card-back fallback.
- Moved toward stable web deployment flow with embedded card images.
